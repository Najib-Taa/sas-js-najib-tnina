...
const mot1Trie = mot1.split("").sort().join("");

const mot2Trie = mot2.split("").sort().join("");

const comparaison_d_anagrammes = (mot1Trie === mot2Trie);

console.log(comparaison_d_anagrammes);