...
while (totalItems > 0) {
    let itemsAExtraire = 0;

    if (totalItems >= itemsPerPage) {
        itemsAExtraire = itemsPerPage;
    } else {
        itemsAExtraire = totalItems;
    }

    console.log(`Scraping page ${page} (${itemsAExtraire} items)`);

    totalItems = totalItems - itemsAExtraire; 
    page++; 
}
