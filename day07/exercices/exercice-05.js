...
function obtenirNombreDeCles(utilisateur) {
    const tableauCles = Object.keys(utilisateur);
    console.log("Nombre de clés :", tableauCles.length);
    return tableauCles.length;
}
const utilisateurTest = { nom: "Najib", age: 21, estAdmin: true };
obtenirNombreDeCles(utilisateurTest);