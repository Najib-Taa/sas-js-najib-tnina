...
function supprimerAdmin(utilisateur) {
    delete utilisateur.estAdmin;
    return utilisateur;
}

const test_d_objet = { nom: "Najib", age: 21, estAdmin: true };
console.log("Avant :", test_d_objet);
supprimerAdmin(test_d_objet);
console.log("Aprés :", test_d_objet);
